...
def exportarParaExcel():
    ...
    workbook = load_workbook(filename="C:\\python_projetos\\python_rpa_projetos\\tkinter\\tree_excel\\Tratamento_Dados.xlsx")
    sheet=workbook["Vendedores"]
    '''
    O método .get_children() retorna uma lista com os identificadores de todas as linhas do Treeview. Assim, o laço for permite acessar cada linha individualmente para, por exemplo, ler, modificar ou excluir seus dados.
    '''
    #for - para
    ...
    #Salvo o arquivo
    workbook.save(filename="C:\\python_projetos\\python_rpa_projetos\\tkinter\\tree_excel\\Dados_Exportados.xlsx")
