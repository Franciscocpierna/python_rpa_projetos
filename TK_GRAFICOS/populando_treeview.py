...
class Application(Frame):
    ...
    def gerar_grafico_funil(self):
        ...
        """
        #iteritems() obsleto do pandas, use items() para versões mais recentes
    ...
    def abrir_janela_editar_dados(self):
        ...
        menu_salvar.add_command(label="Renomear Coluna", command=self.editar_dados.destroy)
        menu_salvar.add_command(label="Remover Coluna", command=self.editar_dados.destroy)
        menu_salvar.add_command(label="Remover Linhas em Branco", command=self.editar_dados.destroy)
        menu_salvar.add_command(label="Remover linhas alternadas", command=self.editar_dados.destroy)
        menu_salvar.add_command(label="Remover duplicados", command=self.editar_dados.destroy)
