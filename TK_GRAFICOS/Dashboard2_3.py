...
class Application(Frame):
    ...
    def abrir_janela_dash1(self):
        ...
        #LANCZOS é uma técnica utilizada para suavizar bordas irregulares em imagens
    ...
    def abrir_janela_dash2(self):
        ...
        self.img1 = ImageTk.PhotoImage(Image.open("image1.png").resize((400,400), Image.LANCZOS))
        self.img2 = ImageTk.PhotoImage(Image.open("image2.png").resize((400,400), Image.LANCZOS))
        self.img3 = ImageTk.PhotoImage(Image.open("image3.png").resize((400,400), Image.LANCZOS))
        self.img4 = ImageTk.PhotoImage(Image.open("image4.png").resize((400,400), Image.LANCZOS))
    ...
    def abrir_janela_dash3(self):
        ...
        self.img3 = ImageTk.PhotoImage(Image.open("image3.png").resize((400,400), Image.LANCZOS))
        self.img4 = ImageTk.PhotoImage(Image.open("image4.png").resize((400,400), Image.LANCZOS))
        self.img5 = ImageTk.PhotoImage(Image.open("image5.png").resize((400,400), Image.LANCZOS))
        self.img6 = ImageTk.PhotoImage(Image.open("image6.png").resize((400,400), Image.LANCZOS))
