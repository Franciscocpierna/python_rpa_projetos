...
#Criando um título
pdf.cell(200, 10, txt = "Escola ABC", ln = 1,
            align = 'C')

#Criando um subtitulo
#Criando uma nova célula / linha
pdf.cell(200, 10, txt = "Turma 5 / 2023", ln = 1,
            align = 'C')

#Criando uma nova célula / linha em branco
...
#Salva o arquivo PDF
pdf.output("C:\\python_projetos\\python_rpa_projetos\\python_pdf_blNotas\\PDF Professora Rosiane.pdf")
