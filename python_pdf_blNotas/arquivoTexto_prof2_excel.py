...
#Verifica se a professora é Carolina ou Rosiane e exibe somente os alunos delas
#Passa os dados da professora Carolina e Rosiane para o arquivo arquivoProfessoraCarolina e arquivoProfessoraRosiane
#Salva ambos os arquivos no Excel
...
arquivoProfessoraRosiane = open('C:\\python_projetos\\python_rpa_projetos\\python_pdf_blNotas\\ProfessoraRosiane.txt', 'w')
arquivo = open('C:\\python_projetos\\python_rpa_projetos\\python_pdf_blNotas\\Alunos.txt', 'r')
arquivoBlocoDeNotas = arquivo.readlines()
#C:\python_projetos\python_rpa_projetos\python_pdf_blNotas
nota1 = 0
nota2 = 0
nota3 = 0
nota4 = 0
    ...
    if professora == "Carolina":
        ...
        #Faço os calculos e tratamento a partir da segunda linha
            ...
            if faltas >= 4:
                ...
                #Escrevendo os itens e o resultado no arquivo de texto
                arquivoProfessoraRosiane.write(';' + nome + '; Média: ' + str(media) + '; Faltas: ' + str(faltas) + '; Reprovado(a) por falta\n')
                ...
                if media >= 6:
                    ...
                    #Escrevendo os itens e o resultado no arquivo de texto
                    arquivoProfessoraRosiane.write(';' + nome + '; Média: ' + str(media) + '; Faltas: ' + str(faltas) + '; Aprovado(a)\n')
                    ...
                    #Escrevendo os itens e o resultado no arquivo de texto
                    arquivoProfessoraRosiane.write(';' + nome + '; Média: ' + str(media) + '; Faltas: ' + str(faltas) + '; Recuperação\n')
                    ...
                    #Escrevendo os itens e o resultado no arquivo de texto
                    arquivoProfessoraRosiane.write(';' + nome + '; Média: ' + str(media) + '; Faltas: ' + str(faltas) + '; Reprovado(a) por Média\n')


            print("-----------------------")
            

#Fecho o arquivo da professora Carolina
arquivoProfessoraCarolina.close()
arquivoProfessoraRosiane.close()
...
#Salva o arquivo em formato de tabela no excel
arquivoDataFrame.to_csv('C:\\python_projetos\\python_rpa_projetos\\python_pdf_blNotas\\ProfessoraCarolina.csv', encoding='utf-8-sig')
df.to_csv('C:\\python_projetos\\python_rpa_projetos\\python_pdf_blNotas\\ProfessoraRosiane.csv', encoding='utf-8-sig')